<form method="post" action="<?php echo url::site('admin/settings/save/');?>">
    ...
    <div class="span-15 last">
        ...
        <small><?php echo html::image('admin/media/images/icons/information.png', array('style' => 'padding:0 5px;')); ?><?php echo __(Kohana::message('admin','leave password empty'));?></small>
